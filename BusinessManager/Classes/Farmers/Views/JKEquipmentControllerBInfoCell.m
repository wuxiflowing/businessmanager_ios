//
//  JKEquipmentControllerBInfoCell.m
//  OperationsManager
//
...
@implementation JKEquipmentControllerBInfoCell
...
- (void)createUI:(JKEquipmentModel *)model {
    ...
    NSString *open = [NSString stringWithFormat:@"%@",model.aeratorControlTwo];
    ...
    deviceTypeValueLb.text = model.ammeterTypeB;
    ...
    nameValueLb.text = model.channelB;
    ...
    if ([ammeterValueLb.text isEqualToString:@"有"]) {
        ...
        ammeterNoValueLb.text = model.ammeterIdB;
        ...
        powerValueLb.text = [NSString stringWithFormat:@"%@",model.powerB];
        ...
        voltageUpLimitValueLb.text = [NSString stringWithFormat:@"%@ V",model.voltageUpB];
        ...
        voltageDownLimitValueLb.text = [NSString stringWithFormat:@"%@ V",model.voltageDownB];
        ...
        ammeterUpLimitValueLb.text = [NSString stringWithFormat:@"%@ A",model.electricCurrentUpB];
        ...
        ammeterDownLimitValueLb.text = [NSString stringWithFormat:@"%@ A",model.electricCurrentDownB];
