...
- (void)createUI:(JKNewEquipmentModel *)model {
    ...
    oUpLimitValueLb.text = [NSString stringWithFormat:@"%@",JKIsNull(model.oxyLimitUp4)];
    ...
    oDownLimitValueLb.text = [NSString stringWithFormat:@"%@",JKIsNull(model.oxyLimitDown4)];
    ...
    ammeterUpLimitValueLb.text = [NSString stringWithFormat:@"%@ A",JKIsNull(model.electricityUp4)];
    ...
    ammeterDownLimitValueLb.text = [NSString stringWithFormat:@"%@ A",JKIsNull(model.electricityDown4)];
