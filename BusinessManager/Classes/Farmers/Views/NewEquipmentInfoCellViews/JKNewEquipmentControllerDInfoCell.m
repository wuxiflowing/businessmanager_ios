...
- (void)createUI:(JKNewEquipmentModel *)model {
    ...
    oUpLimitValueLb.text = model.oxyLimitUp4;
    ...
    oDownLimitValueLb.text = model.oxyLimitDown4;
    ...
    ammeterUpLimitValueLb.text = [NSString stringWithFormat:@"%@ A",model.electricityUp4];
    ...
    ammeterDownLimitValueLb.text = [NSString stringWithFormat:@"%@ A",model.electricityDown4];
    ...
    if ([model.controlStatusAuto4 isEqualToString:@"1"]) {
