...
@implementation JKNewEquipmentControllerDInfoCell
...
- (void)createUI:(JKNewEquipmentModel *)model {
    ...
    NSString *open = [NSString stringWithFormat:@"%@",model.open4];
    ...
    oUpLimitValueLb.text = [NSString stringWithFormat:@"%@",JKSafeNull(model.oxyLimitUp4)];
    ...
    oDownLimitValueLb.text = [NSString stringWithFormat:@"%@",JKSafeNull(model.oxyLimitDown4)];
    ...
    ammeterUpLimitValueLb.text = [NSString stringWithFormat:@"%@ A",JKSafeNull(model.electricityUp4)];
    ...
    ammeterDownLimitValueLb.text = [NSString stringWithFormat:@"%@ A",JKSafeNull(model.electricityDown4)];
    ...
    if ([[NSString stringWithFormat:@"%@",model.controlStatusAuto4] isEqualToString:@"1"]) {
