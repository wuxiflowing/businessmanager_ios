...
@implementation JKNewEquipmentControllerBInfoCell
...
- (void)createUI:(JKNewEquipmentModel *)model {
    ...
    NSString *open = [NSString stringWithFormat:@"%@",model.open2];
    ...
    if ([[NSString stringWithFormat:@"%@",JKSafeNull(model.controlStatusAuto2)] isEqualToString:@"1"]) {
