...
//    }];
    ...
    UILabel *deviceNoLb = [[UILabel alloc] init];
    deviceNoLb.text = [NSString stringWithFormat:@"运维管家：%@",model.matnerMembName];
    deviceNoLb.textColor = RGBHex(0x333333);
    deviceNoLb.textAlignment = NSTextAlignmentLeft;
    deviceNoLb.font = JKFont(14);
    [contentView addSubview:deviceNoLb];
    [deviceNoLb mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    UILabel *faultTypeLb = [[UILabel alloc] init];
    faultTypeLb.text = [NSString stringWithFormat:@"设备型号：%@",model.repairEqpKind];
    faultTypeLb.textColor = RGBHex(0x333333);
    faultTypeLb.textAlignment = NSTextAlignmentLeft;
    faultTypeLb.font = JKFont(14);
    [contentView addSubview:faultTypeLb];
    [faultTypeLb mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(deviceNoLb.mas_bottom).offset(5);
        make.left.equalTo(contentView.mas_left).offset(10);
        make.right.equalTo(contentView.mas_right).offset(-10);
        make.height.mas_equalTo(20);
    }];
    
    UILabel *faultDescriptionValueLb = [[UILabel alloc] init];
    faultDescriptionValueLb.text = [NSString stringWithFormat:@"故障描述：%@", model.maintenDetail];
    faultDescriptionValueLb.textColor = RGBHex(0x333333);
    faultDescriptionValueLb.textAlignment = NSTextAlignmentLeft;
    faultDescriptionValueLb.font = JKFont(14);
    //    faultDescriptionValueLb.numberOfLines = 2;
    //    faultDescriptionValueLb.adjustsFontSizeToFitWidth = YES;
    [contentView addSubview:faultDescriptionValueLb];
    [faultDescriptionValueLb mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(faultTypeLb.mas_bottom).offset(5);
        make.left.equalTo(contentView.mas_left).offset(10);
        make.right.equalTo(contentView.mas_right).offset(-10);
        make.height.mas_equalTo(20);
    }];
    ...
    [realTimeLb mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(faultDescriptionValueLb.mas_bottom).offset(5);
        make.left.equalTo(contentView.mas_left).offset(10);
        make.right.equalTo(contentView.mas_right).offset(-10);
        make.height.mas_equalTo(20);
    }];
