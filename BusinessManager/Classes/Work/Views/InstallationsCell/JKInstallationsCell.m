...
@implementation JKInstallationsCell
...
//    }];
    ...
    deviceNumberLb.text = [NSString stringWithFormat:@"安装设备数量：%@套",model.contractDeviceNum];
    deviceNumberLb.textColor = RGBHex(0x333333);
    deviceNumberLb.textAlignment = NSTextAlignmentLeft;
    deviceNumberLb.font = JKFont(14);
    [contentView addSubview:deviceNumberLb];
    ...
    UILabel *operationNameLb = [[UILabel alloc] init];
    operationNameLb.text = [NSString stringWithFormat:@"运维管家：%@",model.matnerMembName];
    operationNameLb.textColor = RGBHex(0x333333);
    operationNameLb.textAlignment = NSTextAlignmentLeft;
    operationNameLb.font = JKFont(14);
    [contentView addSubview:operationNameLb];
    [operationNameLb mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(deviceNumberLb.mas_bottom).offset(5);
        make.left.equalTo(contentView.mas_left).offset(10);
        make.right.equalTo(contentView.mas_right).offset(-10);
        make.height.mas_equalTo(20);
    }];
    ...
    timeLb.text = [NSString stringWithFormat:@"计划完成时间：%@",model.planFinishTime];
    ...
    [timeLb mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(operationNameLb.mas_bottom).offset(5);
        make.left.equalTo(contentView.mas_left).offset(10);
        make.right.equalTo(contentView.mas_right).offset(-10);
        make.height.mas_equalTo(20);
    }];
    ...
    if (self.installType == JKInstallationWait) {
        ...
        realTimeLb.text = [NSString stringWithFormat:@"实际完成时间：%@",model.calCT];
    }
