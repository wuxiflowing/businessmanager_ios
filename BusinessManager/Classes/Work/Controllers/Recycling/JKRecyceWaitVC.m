...
@interface JKRecyceWaitVC () <UITableViewDelegate, UITableViewDataSource, JKRecyceCellDelegate>
{
    NSInteger _page;
}
...
- (void)getRecyceTaskList:(NSInteger)page {
    NSString *urlStr = [NSString stringWithFormat:@"%@/RESTAdapter/mytask/%@/list/%@/%@?page=%ld",kUrl_Base, [JKUserDefaults objectForKey:@"loginid"],@"subRecycling",@"prepare",(long)page];
