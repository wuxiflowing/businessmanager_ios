...
@interface JKRecycingVC () <UITableViewDelegate, UITableViewDataSource, JKRecyceCellDelegate>
{
    NSInteger _page;
}
...
- (void)getRecyceTaskList:(NSInteger)page {
    NSString *urlStr = [NSString stringWithFormat:@"%@/RESTAdapter/mytask/%@/list/%@/%@?page=%ld",kUrl_Base, [JKUserDefaults objectForKey:@"loginid"],@"subRecycling",@"ing",(long)page];
