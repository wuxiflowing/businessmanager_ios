...
@interface JKRecycePendVC () <UITableViewDelegate, UITableViewDataSource, JKRecyceCheckCellDelegate>
{
    NSInteger _page;
}
...
- (void)getRecyceTaskList:(NSInteger)page {
    NSString *urlStr = [NSString stringWithFormat:@"%@/RESTAdapter/mytask/%@/list/%@/%@?page=%ld",kUrl_Base, [JKUserDefaults objectForKey:@"loginid"],@"recycling",@"sign",(long)page];
    ...
    [[JKHttpTool shareInstance] GetReceiveInfo:nil url:urlStr successBlock:^(id responseObject) {
        ...
        if (responseObject[@"success"]) {
            ...
            for (NSDictionary *dict in responseObject[@"data"]) {
                ...
                model.txtCSMembName = dict[@"txtCenMagName"];
