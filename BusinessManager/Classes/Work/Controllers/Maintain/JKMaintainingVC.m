...
@interface JKMaintainingVC () <UITableViewDelegate, UITableViewDataSource, JKMaintainCellDelegate>
{
    NSInteger _page;
}
...
@implementation JKMaintainingVC
...
- (void)getMaintainTaskList:(NSInteger)page {
    NSString *urlStr = [NSString stringWithFormat:@"%@/RESTAdapter/mytask/%@/list/%@/%@?page=%ld",kUrl_Base, [JKUserDefaults objectForKey:@"loginid"],@"maintain",@"ing",(long)page];
