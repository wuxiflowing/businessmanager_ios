...
@interface JKMaintainWaitVC () <UITableViewDelegate, UITableViewDataSource, JKMaintainCellDelegate>
{
    NSInteger _page;
}
...
@implementation JKMaintainWaitVC
...
- (void)getMaintainTaskList:(NSInteger)page {
    NSString *urlStr = [NSString stringWithFormat:@"%@/RESTAdapter/mytask/%@/list/%@/%@?page=%ld",kUrl_Base, [JKUserDefaults objectForKey:@"loginid"],@"maintain",@"prepare",(long)page];
