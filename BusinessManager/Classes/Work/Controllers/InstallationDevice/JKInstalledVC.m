...
@interface JKInstalledVC () <UITableViewDelegate, UITableViewDataSource,JKInstallationsCellDelegate>
{
    NSInteger _page;
}
...
- (void)getInstallTaskList:(NSInteger)page {
    NSString *urlStr = [NSString stringWithFormat:@"%@/RESTAdapter/mytask/%@/list/%@/%@?page=%ld",kUrl_Base,[JKUserDefaults objectForKey:@"loginid"],@"install",@"finish",(long)page];
