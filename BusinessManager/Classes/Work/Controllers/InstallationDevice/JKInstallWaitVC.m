...
@interface JKInstallWaitVC () <UITableViewDelegate, UITableViewDataSource,JKInstallationsCellDelegate>
{
    NSInteger _page;
}
...
@implementation JKInstallWaitVC
...
- (void)getInstallTaskList:(NSInteger)page {
    NSString *urlStr = [NSString stringWithFormat:@"%@/RESTAdapter/mytask/%@/list/%@/%@?page=%ld",kUrl_Base,[JKUserDefaults objectForKey:@"loginid"],@"install",@"prepare",(long)page];
