...
@interface JKRepairedVC () <UITableViewDelegate, UITableViewDataSource, JKRepairCellDelegate>
{
    CGFloat _lat;
    CGFloat _lng;
    NSInteger _page;
...
- (void)getRepaireTaskList:(NSInteger)page {
    NSString *urlStr = [NSString stringWithFormat:@"%@/RESTAdapter/mytask/%@/list/%@/%@?page=%ld",kUrl_Base, [JKUserDefaults objectForKey:@"loginid"],@"repair",@"finish",(long)page];
