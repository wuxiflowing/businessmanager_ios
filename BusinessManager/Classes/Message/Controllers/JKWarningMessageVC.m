...
@interface JKWarningMessageVC () <UITableViewDelegate, UITableViewDataSource>
{
    NSInteger _page;
}
...
@implementation JKWarningMessageVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    JKAlarmMessageCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if(!cell){
        cell = [[JKAlarmMessageCell alloc]initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:identifier];
