...
- (void)createUI {
    ...
    [self.view addSubview:againPwdTF];
...
- (void)submitBtnClick:(UIButton *)btn {
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@", kUrl_Modify_Pwd];
